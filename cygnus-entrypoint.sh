...
echo "Change parameters in the agent configuration file"
...
echo "Change parameters in the cartodb key configuration file"
...
# Run the cartodb setup
if [ ! -f /root/.cartodbfied.flag ]; then
    echo "Run the cartodb setup"
    /cartodb_tables.sh
    touch /root/.cartodbfied.flag
fi

# Run the Cygnus command
echo "Run the Cygnus command"
